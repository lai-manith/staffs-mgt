...
import { Filter, OptionParam } from 'src/app/models/filter';
@Component({
  selector: 'app-filter-with-create-new',
  templateUrl: './filter-with-create-new.component.html',
  styleUrls: ['./filter-with-create-new.component.scss']
})
export class FilterWithCreateNewComponent {
  @Output() createNew: EventEmitter<any> = new EventEmitter();
  @Input() btnText?: string = "បង្កើតថ្មី";
